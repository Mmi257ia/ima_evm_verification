...
def creat(m: Machine,
    ...
    m.O_CREAT in (~flags))) or (_(12, m.O_TMPFILE in (~flags)))))

    _grd12 = Guard('grd12', lambda _: (((_(13, 
    m.O_RDONLY in (~flags))) or (_(14, m.O_WRONLY in (~flags)))) or (_(15, m.O_RDWR in (~flags)))))

    _grd13 = Guard('grd13', lambda _: (((not ((_(16, 
    m.O_RDONLY in (~flags))) and (_(17, m.O_WRONLY in (~flags))))) and (not ((_(18, 
    m.O_RDONLY in (~flags))) and (_(19, m.O_RDWR in (~flags)))))) and (not ((_(20, 
    m.O_WRONLY in (~flags))) and (_(21, m.O_RDWR in (~flags)))))))

    _grd14 = Guard('grd14', lambda _: (not (_(22, 
    m.O_TMPFILE in (~flags))) or ((_(23, m.O_WRONLY in (~flags))) or (_(24, m.O_RDWR in (~flags))))))
    ...
    _grd19 = Guard('grd19', lambda _: (_(29, 
    ...
    _grd20 = Guard('grd20', lambda _: (not (_(30, 
    function_value(m.ProcUser, (~proc)) != m.ROOT_USER)) or (((((((_(31, 
    function_value(m.ProcUser, (~proc)) == function_value(m.FileUser, (~parent)))) and (_(32, 
    frozenset((m.UWRITE, m.UEXECUTE)) <= function_value(m.DACPermissions, (~parent))))) or (((((_(33, 
    function_value(m.ProcUser, (~proc)) != function_value(m.FileUser, (~parent)))) and ((_(34, 
    (~parent) not in relation_domain(m.MaskACL))) or (_(35, len(function_value(m.MaskACL, (~parent))) == 0)))) and (_(36, 
    function_value(m.FileGroup, (~parent)) != function_value(m.ProcGroup, (~proc))))) and (_(37, (function_value(m.ProcUser, (~proc)), function_value(m.FileGroup, (~parent))) not in m.UserGroups))) and (_(38, 
    frozenset((m.OWRITE, m.OEXECUTE)) <= function_value(m.DACPermissions, (~parent)))))) or ((((_(39, 
    function_value(m.ProcUser, (~proc)) != function_value(m.FileUser, (~parent)))) and (_(40, 
    ((~parent), function_value(m.ProcUser, (~proc))) in relation_domain(m.UserACL)))) and (_(41, frozenset((m.UWRITE, m.UEXECUTE)) <= function_value(m.UserACL, ((~parent), function_value(m.ProcUser, (~proc))))))) and (_(42, 
    frozenset((m.GWRITE, m.GEXECUTE)) <= function_value(m.MaskACL, (~parent)))))) or (((((_(43, 
    function_value(m.ProcUser, (~proc)) != function_value(m.FileUser, (~parent)))) and (_(44, 
    ((~parent), function_value(m.ProcUser, (~proc))) not in relation_domain(m.UserACL)))) and (_(45, 
    any (True for g in (frozenset((function_value(m.ProcGroup, (~proc)),)) | relation_range(m.UserGroups)) if 
    (g == function_value(m.ProcGroup, (~proc)) or (function_value(m.ProcUser, (~proc)), g) in m.UserGroups) if 
    (((~parent), g) in relation_domain(m.GroupACL) and frozenset((m.GWRITE, m.GEXECUTE)) <= function_value(m.GroupACL, ((~parent), g)) or g == function_value(m.FileGroup, (~parent)) and (~parent) in relation_domain(m.GroupObjACL) and frozenset((m.GWRITE, m.GEXECUTE)) <= function_value(m.GroupObjACL, (~parent))))))) and (_(46, 
    (~parent) in relation_domain(m.MaskACL)))) and (_(47, frozenset((m.GWRITE, m.GEXECUTE)) <= function_value(m.MaskACL, (~parent)))))) or ((((_(48, 
    function_value(m.ProcUser, (~proc)) != function_value(m.FileUser, (~parent)))) and (_(49, 
    (~parent) not in relation_domain(m.MaskACL)))) and ((_(50, 
    function_value(m.FileGroup, (~parent)) == function_value(m.ProcGroup, (~proc)))) or (_(51, (function_value(m.ProcUser, (~proc)), function_value(m.FileGroup, (~parent))) in m.UserGroups)))) and (_(52, 
    frozenset((m.GWRITE, m.GEXECUTE)) <= function_value(m.DACPermissions, (~parent)))))) or ((((((((_(53, 
    function_value(m.ProcUser, (~proc)) != function_value(m.FileUser, (~parent)))) and (_(54, 
    (~parent) in relation_domain(m.MaskACL)))) and (_(55, len(function_value(m.MaskACL, (~parent))) != 0))) and (_(56, 
    ((~parent), function_value(m.ProcUser, (~proc))) not in relation_domain(m.UserACL)))) and (_(57, 
    not any (True for g in (frozenset((function_value(m.ProcGroup, (~proc)),)) | relation_range(m.UserGroups)) if (g == function_value(m.ProcGroup, (~proc)) or (function_value(m.ProcUser, (~proc)), g) in m.UserGroups) if not (
        ((~parent), g) not in relation_domain(m.GroupACL)
    ))))) and (_(58, 
    function_value(m.FileGroup, (~parent)) != function_value(m.ProcGroup, (~proc))))) and (_(59, (function_value(m.ProcUser, (~proc)), function_value(m.FileGroup, (~parent))) not in m.UserGroups))) and (_(60, 
    frozenset((m.OWRITE, m.OEXECUTE)) <= function_value(m.DACPermissions, (~parent))))))))

    _grd21 = Guard('grd21', lambda _: (_(61, 
    (~group) in m.Groups)))

    _grd22 = Guard('grd22', lambda _: (not (_(62, 
    m.SET_GID not in function_value(m.DACPermissions, (~parent)))) or (_(63, (~group) == function_value(m.ProcGroup, (~proc))))))

    _grd23 = Guard('grd23', lambda _: (not (_(64, 
    m.SET_GID in function_value(m.DACPermissions, (~parent)))) or (_(65, (~group) == function_value(m.FileGroup, (~parent))))))

    _grd24 = Guard('grd24', lambda _: (_(66, 
    (~perms) == ((~mode) - ((~mode) & function_value(m.ProcUmask, (~proc)))))))

    _grd25 = Guard('grd25', lambda _: (_(67, (~flags) == frozenset((m.O_CREAT, m.O_WRONLY, m.O_TRUNC)))))
    ...
    return Event("creat", _grd1, _grd2, _grd3, _grd4, _grd5, _grd6, _grd7, _grd8, _grd9, _grd10, _grd11, _grd12, _grd13, _grd14, _grd15, _grd16, _grd17, _grd18, _grd19, _grd20, _grd21, _grd22, _grd23, _grd24, _grd25, _act1, _act2, _act3, _act4, _act5, _act6, _act7, _act8, _act9, _act10, _act11, _act12)
