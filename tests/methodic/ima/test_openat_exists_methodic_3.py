from os import O_RDONLY, O_WRONLY, O_RDWR, O_DIRECTORY
...
parent immutable
"""
def test_openat_exists_methodic_3(t: LinuxTestSpec, access_mode):
    ...
    try:
        with t.make_program_and_run(ima_user, ima_user, ima_evm_dir=ima_evm_dir, umask=0) as child:
            ...
            child.openat(dir_fd, 'file', flags, 0, fatal=True)
    except AssertionError as e:
        print(f"Rightfully caught exception: {mode_name} {e}")
