"""
Отдельно надо проверить работу подсистемы обеспечения целостности. Для этого
нужно применить операции доступа на чтение, модификацию и запуск к набору
файлов, в котором имеются файлы следующих видов
...
▪ некорректные контролируемые подсистемой обеспечения целостности 
(с сохраненным некорректным хэш-кодом), 
неизменяемые (с установленнымсатрибутом immutable)
"""
